...
def extract_table_from_html(html_string):
    ...
    try:
        ...
        logger.info(f"extract_table_from_html error: {str(e)}")
...
class MarkdownConverter:
    ...
    def try_remove_newline(self, text: str) -> str:
        try:
            ...
            logger.info(f"try_remove_newline error: {str(e)}")
    ...
    def _handle_text(self, text: str) -> str:
        ...
        try:
            ...
            logger.info(f"_handle_text error: {str(e)}")
            return text  # Return original text on error
    ...
    def _process_formulas_in_text(self, text: str) -> str:
        ...
        try:
            ...
            logger.info(f"_process_formulas_in_text error: {str(e)}")
            return text  # Return original text on error
    ...
    def _remove_newline_in_heading(self, text: str) -> str:
        ...
        try:
            ...
            logger.info(f"_remove_newline_in_heading error: {str(e)}")
            return text
    ...
    def _handle_heading(self, text: str, label: str) -> str:
        ...
        try:
            ...
            logger.info(f"_handle_heading error: {str(e)}")
    ...
    def _handle_list_item(self, text: str) -> str:
        ...
        try:
            ...
            logger.info(f"_handle_list_item error: {str(e)}")
    ...
    def _handle_figure(self, text: str, section_count: int) -> str:
        ...
        try:
            ...
            logger.info(f"_handle_figure error: {str(e)}")
    ...
    def _handle_table(self, text: str) -> str:
        ...
        try:
            ...
            logger.info(f"_handle_table error: {str(e)}")
    ...
    def _handle_algorithm(self, text: str) -> str:
        ...
        try:
            ...
            logger.info(f"_handle_algorithm error: {str(e)}")
    ...
    def _handle_formula(self, text: str) -> str:
        ...
        try:
            ...
            logger.info(f"_handle_formula error: {str(e)}")
        ...
        try:
            ...
            for section_count, result in enumerate(recognition_results):
                try:
                    ...
                    logger.info(f"Error processing item {section_count}: {str(e)}")
            ...
            logger.info(f"convert error: {str(e)}")
    ...
    def _post_process(self, markdown_content: str) -> str:
        ...
        try:
            ...
            logger.info(f"_post_process error: {str(e)}")
